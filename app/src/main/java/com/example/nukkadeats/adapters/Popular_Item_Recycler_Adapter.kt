...
class Popular_Item_Recycler_Adapter(
    private val itemsName: List<String>,
    private val itemPrice: List<String>,
    private val itemImage: List<Int>,
    private val itemDescription: List<String>,
    private val context: Context
) : RecyclerView.Adapter<Popular_Item_Recycler_Adapter.ViewHolder>() {
    class ViewHolder(private val binding: PopularItemRecyclerBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            PopularItemRecyclerBinding.inflate(
